...
import uk.gov.hmcts.sptribs.cases.model.ContactDetailsType;
...
import static uk.gov.hmcts.sptribs.document.DocumentConstants.GENERAL_LETTER_DOCUMENT_NAME;
import static uk.gov.hmcts.sptribs.document.DocumentConstants.GENERAL_LETTER_TEMPLATE_ID;
import static uk.gov.hmcts.sptribs.document.DocumentConstants.NFD_NOP_A1_SOLE_APP1_CIT_CS;
import static uk.gov.hmcts.sptribs.document.DocumentConstants.NOTICE_OF_PROCEEDINGS_DOCUMENT_NAME;
import static uk.gov.hmcts.sptribs.document.model.DocumentType.EMAIL;
...
class CaseDataDocumentServiceTest {
    ...
    public void shouldGenerateConfidentialDocumentsWhenDocumentTypeIsOther() {
        ...
        classMock.when(() -> DocumentUtil.isApplicableForConfidentiality(DocumentType.OTHER, null)).thenReturn(true);
