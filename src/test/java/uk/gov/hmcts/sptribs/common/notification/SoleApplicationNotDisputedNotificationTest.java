...
import static uk.gov.hmcts.sptribs.notification.CommonContent.IS_DISPUTED;
...
import static uk.gov.hmcts.sptribs.notification.CommonContent.IS_UNDISPUTED;
...
import static uk.gov.hmcts.sptribs.notification.EmailTemplateName.SOLE_APPLICANT_AOS_SUBMITTED;
import static uk.gov.hmcts.sptribs.notification.EmailTemplateName.SOLE_RESPONDENT_AOS_SUBMITTED;
...
import static uk.gov.hmcts.sptribs.testutil.TestConstants.PROFESSIONAL_USERS_SIGN_IN_URL;
...
import static uk.gov.hmcts.sptribs.testutil.TestDataHelper.validCaseDataForAosSubmitted;
