...
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.APPLICANT_1_ADDRESS;
...
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.ARRANGE_SERVICE_BY_DATE;
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.BAILIFF_SERVICE_COST;
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.CASE_REFERENCE;
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.CONTACT_DIVORCE_EMAIL;
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.CP_CASE_EMAIL;
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.DEEMED_SERVICE_COST;
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.DISPENSED_SERVICE_COST;
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.DIVORCE_OR_CIVIL_PARTNERSHIP_EMAIL;
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.DIVORCE_OR_CIVIL_PARTNERSHIP_SERVICE_HEADER;
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.DIVORCE_SERVICE;
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.END_CP_SERVICE;
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.ISSUE_DATE;
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.RELATION;
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.SEARCH_ADDRESS_COST;
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.SERVE_BY_EMAIL_COST;
...
import static uk.gov.hmcts.sptribs.payment.FeesAndPaymentsUtil.formatAmount;
import static uk.gov.hmcts.sptribs.payment.PaymentService.EVENT_ENFORCEMENT;
import static uk.gov.hmcts.sptribs.payment.PaymentService.EVENT_GENERAL;
import static uk.gov.hmcts.sptribs.payment.PaymentService.KEYWORD_BAILIFF;
import static uk.gov.hmcts.sptribs.payment.PaymentService.KEYWORD_WITHOUT_NOTICE;
import static uk.gov.hmcts.sptribs.payment.PaymentService.SERVICE_OTHER;
