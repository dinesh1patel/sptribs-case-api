...
import uk.gov.hmcts.sptribs.cases.model.JurisdictionConnections;
import uk.gov.hmcts.sptribs.cases.model.LanguagePreference;
import uk.gov.hmcts.sptribs.common.exception.InvalidCcdCaseDataException;
...
import static uk.gov.hmcts.sptribs.cases.model.JurisdictionConnections.APP_1_APP_2_DOMICILED;
import static uk.gov.hmcts.sptribs.cases.model.JurisdictionConnections.APP_1_APP_2_LAST_RESIDENT;
import static uk.gov.hmcts.sptribs.cases.model.JurisdictionConnections.APP_1_APP_2_RESIDENT;
import static uk.gov.hmcts.sptribs.cases.model.JurisdictionConnections.APP_1_DOMICILED;
import static uk.gov.hmcts.sptribs.cases.model.JurisdictionConnections.APP_1_RESIDENT_JOINT;
import static uk.gov.hmcts.sptribs.cases.model.JurisdictionConnections.APP_1_RESIDENT_SIX_MONTHS;
import static uk.gov.hmcts.sptribs.cases.model.JurisdictionConnections.APP_1_RESIDENT_TWELVE_MONTHS;
import static uk.gov.hmcts.sptribs.cases.model.JurisdictionConnections.APP_2_DOMICILED;
import static uk.gov.hmcts.sptribs.cases.model.JurisdictionConnections.APP_2_RESIDENT_JOINT;
import static uk.gov.hmcts.sptribs.cases.model.JurisdictionConnections.APP_2_RESIDENT_SOLE;
import static uk.gov.hmcts.sptribs.cases.model.JurisdictionConnections.RESIDUAL_JURISDICTION_CP;
import static uk.gov.hmcts.sptribs.cases.model.JurisdictionConnections.RESIDUAL_JURISDICTION_D;
import static uk.gov.hmcts.sptribs.cases.model.LanguagePreference.WELSH;
import static uk.gov.hmcts.sptribs.cases.validation.ValidationUtil.EMPTY;
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.COUNTRY_OF_MARRIAGE;
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.MARRIAGE_DATE;
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.PLACE_OF_MARRIAGE;
