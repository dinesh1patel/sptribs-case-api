...
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.CTSC_CONTACT_DETAILS;
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.DIVORCE_OR_DISSOLUTION;
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.DIVORCE_PROCESS;
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.DIVORCE_PROCESS_CY;
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.DOCUMENTS_ISSUED_ON;
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.DUE_DATE;
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.IS_SERVICE_ORDER_TYPE_DEEMED;
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.PETITIONER_FULL_NAME;
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.PROCESS_TO_END_YOUR_CIVIL_PARTNERSHIP;
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.PROCESS_TO_END_YOUR_CIVIL_PARTNERSHIP_CY;
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.REFUSAL_REASON;
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.RESPONDENT_FULL_NAME;
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.SERVICE_APPLICATION_DECISION_DATE;
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.SERVICE_APPLICATION_RECEIVED_DATE;
