...
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.CIVIL_PARTNERSHIP_CASE_JUSTICE_GOV_UK;
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.CONTACT_DIVORCE_JUSTICE_GOV_UK;
...
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.FOR_A_DIVORCE;
...
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.NOT_REPRESENTED;
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.PROCESS_TO_END_YOUR_CIVIL_PARTNERSHIP;
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.RESPONDENT_SOLICITOR_REGISTERED;
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.RESPOND_BY_DATE;
...
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.SOLICITOR_NAME_WITH_DEFAULT_VALUE;
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.SOLICITOR_REFERENCE;
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.WHO_APPLIED;
