...
import static uk.gov.hmcts.sptribs.cases.util.AddressUtil.getPostalAddress;
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.CASE_REFERENCE;
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.CIVIL_PARTNER;
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.CTSC_CONTACT_DETAILS;
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.FEEDBACK;
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.HUSBAND_OR_WIFE;
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.ISSUE_DATE;
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.IS_JOINT;
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.NAME_FORMAT;
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.RECIPIENT_ADDRESS;
import static uk.gov.hmcts.sptribs.document.content.DocmosisTemplateConstants.RECIPIENT_NAME;
