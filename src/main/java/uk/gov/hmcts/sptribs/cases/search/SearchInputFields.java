package uk.gov.hmcts.sptribs.cases.search;
...
import static uk.gov.hmcts.sptribs.cases.search.CaseFieldsConstants.APPLICANT_NAME;
import static uk.gov.hmcts.sptribs.cases.search.CaseFieldsConstants.CASE_STATE;
import static uk.gov.hmcts.sptribs.cases.search.CaseFieldsConstants.CCD_REFERENCE;
import static uk.gov.hmcts.sptribs.cases.search.CaseFieldsConstants.HEARING_LOCATION;
import static uk.gov.hmcts.sptribs.cases.search.CaseFieldsConstants.REPRESENTATIVE_REFERENCE;
import static uk.gov.hmcts.sptribs.cases.search.CaseFieldsConstants.SUBJECT_ADDRESS;
import static uk.gov.hmcts.sptribs.cases.search.CaseFieldsConstants.SUBJECT_DATE_OF_BIRTH;
import static uk.gov.hmcts.sptribs.cases.search.CaseFieldsConstants.SUBJECT_NAME;
